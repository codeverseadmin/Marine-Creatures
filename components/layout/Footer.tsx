          ...
          <div className="md:col-span-3">
            ...
            <div className="space-y-3 text-xs sm:text-sm">
              <a
                ...
                className="font-body font-light text-[--color-muted] hover:text-[--color-text] transition-colors flex items-start gap-2 group"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="font-body font-light text-[--color-muted] hover:text-[--color-accent] transition-colors flex items-start gap-2 group"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="font-body font-light text-[--color-muted] hover:text-[#1877F2] transition-colors flex items-start gap-2 group"
              >
