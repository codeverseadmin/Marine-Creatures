...
export const PRODUCTS: Product[] = [
  ...
  // 2. LIGHTING & TECH
  {
    ...
    deliveryInfo: {
      estimatedDays: '2-4 Days Express Tracked Courier',
  ...
  },
  {
    ...
    deliveryInfo: {
      estimatedDays: '2-4 Days Tracked Courier',
  ...
  },
  {
    ...
    deliveryInfo: {
      estimatedDays: '2-4 Days Standard Courier',
  ...
  // 4. SALTS & WATER CARE
  {
    ...
    deliveryInfo: {
      estimatedDays: '2-4 Days Fast Dispatch',
